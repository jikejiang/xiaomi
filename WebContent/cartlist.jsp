	...
	<link rel="stylesheet" type="text/css" href="./css/style.css">
 		...
 		<script type="text/javascript">
	 		...
	 		function change_number(obj){
	 			...
	 			//获取当前good对象的库存
	 			var max = obj.max;
	 			if(parseInt(num) > parseInt(max-1)){
	 				alert("库存不足");
	 				$("#good_num").val(num - 1);
	 			}else if (num == 0){
	 				alert("该宝贝不能减少了哟~");
	 				...
	 				var id = $(obj).parents(".content2").prev("#cart_id").val();
	 				alert(id); */
	 			}
	 		}
	 		function settlement(){
			...
			<div class="gwcxd center">
				...
				<input type = "hidden" id = "temperate_id" name = "temperate_id" value = "flag"/>
					<div class="content2 center">
						...
						<div class="sub_content fl">
							<input class="shuliang" type="number" autocomplete="off" id = "good_num" name = "good_num" value="${list.goodNum}" step="1" min="1" max="${list.g.goodCount + 1 }" onblur="change_number(this)">
						</div>
