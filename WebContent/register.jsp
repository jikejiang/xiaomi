...
<meta charset="UTF-8">
   ...
   <script type="text/javascript">
	   function check_data()
	   {
		var reg1 = /^[a-zA-Z_]\w{3,15}$/; //用户名:长度在6-16,只能用数字字母下划线,数字不能开头
		...
		<div class="regist">
			<div class="regist_center">
				...
				<div class="regist_main center">
					<div class="username">用&nbsp;&nbsp;户&nbsp;&nbsp;名:&nbsp;&nbsp;<input class="shurukuang" type="text" name="username" placeholder="请输入你的用户名"/><span>用户名长度在4-16位</span></div>
